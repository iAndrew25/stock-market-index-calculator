...
const MyComponent = () => {
	...
	return (
		<ScrollView style={styles.wrapper}>
			...
			<Text variant="titleLarge" style={[styles.select, {marginLeft: defaultMargin}]}>Select an index</Text>
			<View style={styles.indexes}>
				{indexes.map(({country, indexName, flag}) => (
					<View style={[styles.cardWrapper, {marginBottom: defaultMargin}]} key={country}>
						<Image source={flag} />
						<View>
